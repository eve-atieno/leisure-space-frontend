              ...
              <div className="mt-10 ">
                ...
                <div className="mt-4">
                  <p className="ml-6 text-gray-400">
                    Fast wifi at 315 Mbps, plus a dedicated workspace in a
                    common area.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-10">
                ...
                <div className="mt-4 space-y-6">
                  ...
                  <p className=" text-sm text-gray-600 mt-4">
                    ...
                    free private parking.Kenyatta International Conference
                    Centre is 8 km from the apartment, while Nairobi National
                    Museum is 11 km away. The nearest airport is Wilson Airport,
                    7 km from Sente Airbnb.
                  </p>
                </div>
              </div>
            </div>
