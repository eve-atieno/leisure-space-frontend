                ...
                <div className="md:py-20 xl:w-1/2 sm:w-1/2 lg:mr-20 md:mr-6 flex flex-col md:items-end items-center justify-center xl:mr-28">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="sm:w-96 w-full mt-6 text-base leading-6 text-center text-gray-600">
                                 Leisure Space is an online marketplace that connects users with unique and cool spaces that can be rented by the hour or day for meetings, events, or activities. The platform brings together people with a shared passion or interest in a particular area, allowing them to meet, create, and celebrate within a cool environment generated by willing space owners around the country.</p>
                    ...
                    <div className="mt-7 flex flex-col items-center">
                      ...
                      <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">Phone number 07941178</p><p>Email leisurespace@gmail.com</p>
                    </div>
                    {/* <div className="mt-7 flex flex-col items-center">
